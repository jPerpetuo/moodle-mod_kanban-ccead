...
$string['boardgroupsdescription'] = 'Choose which groups may appear as boards when the activity uses one board per group.';
...
$string['applytemplatetothisboardconfirm'] = 'This will replace all columns and cards in the current board with the saved template. Continue?';
$string['applytemplatetoallgroupboards'] = 'Apply template to all group boards';
$string['applytemplatetoallgroupboardsconfirm'] = 'This will replace all columns and cards in every configured group board with the saved template. Continue?';
